var to, from, modalTrigger, modalFired, sessionInfo; 
...
var runUpgradeProcess = function(){
    checkForElement(subscriptionLabel, 2E4, checkForExistingSubscription);
    if(!subscriptionLabel ){
        injectModalTrigger();
        injectExitDetection();
        injectEntranceDetection();
...
try{
    checkForElement(availableUpgrade, 2E4, runUpgradeProcess);
}catch(e){
